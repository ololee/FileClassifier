 ...
 * 使用自定义的前缀树建议参照{@link DefaultConstants}设计
...
public class FileClassifierHelper {
  ...
  public static void init() {
    //todo:初始化前缀树
    defaultTrieMap.put(DefaultConstants.FileTypeConstants.TYPE_IMAGE,
        Arrays.asList(DefaultConstants.SuffixConstants.IMAGES));
    defaultTrieMap.put(DefaultConstants.FileTypeConstants.TYPE_AUDIO,
        Arrays.asList(DefaultConstants.SuffixConstants.AUDIOS));
    defaultTrieMap.put(DefaultConstants.FileTypeConstants.TYPE_VIDEO,
        Arrays.asList(DefaultConstants.SuffixConstants.VIDEOS));
    defaultTrieMap.put(DefaultConstants.FileTypeConstants.TYPE_DOC_PDF,
        Arrays.asList(DefaultConstants.SuffixConstants.PDF));
    defaultTrieMap.put(DefaultConstants.FileTypeConstants.TYPE_DOC_PPT,
        Arrays.asList(DefaultConstants.SuffixConstants.PPTS));
    defaultTrieMap.put(DefaultConstants.FileTypeConstants.TYPE_DOC_EXCEL,
        Arrays.asList(DefaultConstants.SuffixConstants.EXCELS));
    defaultTrieMap.put(DefaultConstants.FileTypeConstants.TYPE_DOC_WORD,
        Arrays.asList(DefaultConstants.SuffixConstants.WORDS));
    defaultTrieMap.put(DefaultConstants.FileTypeConstants.TYPE_DOC_TXT,
        Arrays.asList(DefaultConstants.SuffixConstants.TXTS));
    defaultTrieMap.put(DefaultConstants.FileTypeConstants.TYPE_COMPRESS,
        Arrays.asList(DefaultConstants.SuffixConstants.COMPRESS));
    defaultTrieMap.put(DefaultConstants.FileTypeConstants.TYPE_EXECUTE,
        Arrays.asList(DefaultConstants.SuffixConstants.APK));
  ...
  public static int getFileType(File file) {
    if (file.isHidden()) {
      return DefaultConstants.FileTypeConstants.TYPE_HIDDEN;
    }
    if (file.isDirectory()) {
      return DefaultConstants.FileTypeConstants.TYPE_FOLDER;
    }
